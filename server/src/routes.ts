...
const pointsCotnroller = new PointsController();
...
routes.post('/points', pointsCotnroller.create);
routes.get('/points', pointsCotnroller.index);
routes.get('/points/:id', pointsCotnroller.show);
